...
{
	static void SaveImage(std::wstring nameFile, std::vector<BYTE4> *dataBuffer, int height, int width);
	static void SaveImage(std::wstring nameFile, std::vector<Float4> *dataBuffer, int height, int width);
	static void SaveImage(std::wstring nameFile, std::vector<float> *dataBuffer, int height, int width);
	static void SaveImageNorm(std::wstring nameFile, std::vector<float> *dataBuffer, int height, int width);
	static void LoadImageFromFile(std::wstring nameFile, std::vector<BYTE4> *dataBuffer, int &outHeight, int &outWidth);
